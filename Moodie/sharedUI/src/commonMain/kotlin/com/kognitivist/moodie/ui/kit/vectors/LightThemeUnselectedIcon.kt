...
val VectorRes.LightThemeUnselectedIcon: ImageVector
    get() {
        if (_LightThemeUnselectedIcon != null) {
            return _LightThemeUnselectedIcon!!
        }
        _LightThemeUnselectedIcon = ImageVector.Builder(
            name = "LightThemeUnselectedIcon",
            defaultWidth = 30.dp,
            defaultHeight = 30.dp,
            viewportWidth = 30f,
            viewportHeight = 30f
            ...
            path(fill = SolidColor(Color(0xFF725D78))) {
                moveTo(17.656f, 17.656f)
                curveTo(18.385f, 16.927f, 18.75f, 16.042f, 18.75f, 15f)
                curveTo(18.75f, 13.958f, 18.385f, 13.073f, 17.656f, 12.344f)
                curveTo(16.927f, 11.615f, 16.042f, 11.25f, 15f, 11.25f)
                curveTo(13.958f, 11.25f, 13.073f, 11.615f, 12.344f, 12.344f)
                curveTo(11.615f, 13.073f, 11.25f, 13.958f, 11.25f, 15f)
                curveTo(11.25f, 16.042f, 11.615f, 16.927f, 12.344f, 17.656f)
                curveTo(13.073f, 18.385f, 13.958f, 18.75f, 15f, 18.75f)
                curveTo(16.042f, 18.75f, 16.927f, 18.385f, 17.656f, 17.656f)
                close()
...
private var _LightThemeUnselectedIcon: ImageVector? = null
