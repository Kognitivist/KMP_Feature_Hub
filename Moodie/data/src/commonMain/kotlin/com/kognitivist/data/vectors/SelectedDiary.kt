...
val VectorRes.SelectedDiary: ImageVector
    get() {
        if (_SelectedDiary != null) {
            return _SelectedDiary!!
        }
        _SelectedDiary = ImageVector.Builder(
            name = "SelectedDiary",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            ...
            path(fill = SolidColor(Color(0xFFB24F9C))) {
                ...
                curveTo(2.333f, 4.817f, 3.138f, 4.521f, 3.963f, 4.313f)
                curveTo(4.787f, 4.104f, 5.633f, 4f, 6.5f, 4f)
                ...
                curveTo(18.367f, 4f, 19.212f, 4.104f, 20.038f, 4.313f)
                curveTo(20.862f, 4.521f, 21.667f, 4.817f, 22.45f, 5.2f)
...
private var _SelectedDiary: ImageVector? = null
